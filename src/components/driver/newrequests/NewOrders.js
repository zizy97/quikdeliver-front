...
import {Container,Grid,Button, Typography, Popper, Fade,Paper,} from '@mui/material';
...
const PopperPad = () => {
  ...
  return(
    <PopupState variant="popper" popupId="demo-popup-popper">
      {(popupState) => (
        <div>
          <Button variant="contained" {...bindToggle(popupState)} sx={{borderRadius:'18px',fontSize:{xs:'12px',sm:'13px',md:'14px',lg:'15px'}}}>
            View details
          </Button>
          <Popper {...bindPopper(popupState)} transition>
            {({ TransitionProps }) => (
              <Fade {...TransitionProps} timeout={350}>
                <Paper sx={{width:'55vw',marginLeft:-50,boxShadow:"0 0 4px 0 rgba(0,0,0,0.6)"}}>
                  <Typography variant="body2" color="initial">ABC</Typography>
                </Paper> 
              </Fade>
            )}
          </Popper>
    ...
    renderCell: () => {
      return (
        <div style={{
          ...
          <Button variant="contained" sx={{borderRadius:'18px',fontSize:{xs:'12px',sm:'13px',md:'14px',lg:'15px'}}}>
            Accept
          </Button>
        </div>
      );
    ...
    renderCell: () => {
      return (
        <div style={{
          ...
          <Button variant="outlined" sx={{borderRadius:'18px',fontSize:{xs:'12px',sm:'13px',md:'14px',lg:'15px'}}}>
            Decline
          </Button>
        </div>
      );
...
const Processlist = () => {
  return (
    <Container sx={{ height: 400, width: '100%' ,m:0,mt:10}}>
      <DataGrid
        elevation={3}
        sx={{
...
const NewOrders = () => {
    return (
        <Container>
          ...
          >
            <Typography variant="h5" sx={{fontWeight:'bold',color:blue[900]}}>New Requests</Typography>
          </Grid>
          <hr/>
          <Processlist/>
        </Container>
